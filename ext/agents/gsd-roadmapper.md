...
Reference full template: `/Users/markalston/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/markalston/.claude/get-shit-done/templates/state.md`.
