...
```bash
INIT=$(node /Users/markalston/.claude/get-shit-done/bin/gsd-tools.cjs state load)
...
```bash
node /Users/markalston/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
